...
namespace JobSeed.Migrations
{
    ...
    [Migration("20240616090523_AddImageLink_JobTable")]
    partial class AddImageLink_JobTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobSeed.Models.JobDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JobSeed.Models.JobDetail", b =>
                {
                    b.HasOne("JobSeed.Models.Job", "Job")
                        .WithOne("JobDetail")
                        .HasForeignKey("JobSeed.Models.JobDetail", "JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
